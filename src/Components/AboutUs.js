...
function AboutUs() {
    return (<><div id="about_us" className="cards w-full">
        ...
        <AboutUsCard title="Love2D Team" text="Here, we create games using the Love2D Game Engine Framework and also conduct workshops on Lua, and other libraries based on it." image={code_image} />
        <AboutUsCard title="Unity Team" text="Here we make games using the Unity Game Engine and teach students about Unity Interface, scripting, Unity Input System, etc." image={unity} />
        <AboutUsCard title="Design Team" text="When you see an amazing piece of artwork in any of our games and websites, it is thanks to our designers in this team! Here we work primarily in Blender for 3D modelling and Illustrator for 2D artworks." image={graphic} />
        <AboutUsCard title="Marketing Team" text="If you want to collaborate with us and make games happen, you contact us! Plus the growth and publicity of our club is our responsibility!" image={marketing} />
        <AboutUsCard title="WebDev Team" text="Pushing the games made by our club to various platforms and updating this website is the job we do! Also we organize activities to help open-source web development!" image={web_design} />
    </div>
