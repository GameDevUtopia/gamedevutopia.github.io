...
{
    return (
      <div className='m-4 lg:m-10 lg:w-80 sm:w-56 lg:h-96 md:h-80 sm:h-72 w-56 min-[320px]:h-80 ' >
       <CCard className="mb-3 " style={{backgroundColor:"#EEEEEE3B", height:"100%", width:"100%" }} >
    <CRow className="g-0">
      <CCol md={8} style={{margin:"0 auto" }} className='card_image'>
      <div className=' lg:h-40 md:h-36 md:w-36 lg:w-full  '>

      <CCardImage src={fimage}  style={{}} className='min-[320px]:max-md:h-40 min-[320px]:max-md:w-20 p-1 '/>
      </div>
